...
extension RedBlackTree2 {
    class Node {
        ...
        var left: Node? = nil
        var right: Node? = nil
        var mutationCount: Int64 = 0 // How many times the values was mutated since its creation
...
extension RedBlackTree2 {
    fileprivate mutating func makeRootUnique() -> Node? {
        // This is a bug!
        // let root counts up the referencecount so that isKnownUniquelyReferenced returns always false.
        // if let root = self.root, !isKnownUniquelyReferenced(&root) {
...
extension RedBlackTree2.Index {
    // Precontidion: 'self' is a valid index.
