...
extension OrderedSet {
    public func contains(_ element: Element) -> Bool {
        ...
        // This is a bug.
        // It returns always false if element is Swift type that is not Hashable.
        // return storage.contains(element)
    }
    
    // For Hashable elements, this will return true faster than index(of:).
    // However, it is slightly slower for values that are not members of the set
    // and for types that are not hashable.
